...
export default function BookConsultation() {
  return (
    <div className="mx-auto max-w-360 cursor-default px-6 pt-0 pb-4 text-center md:pb-12 lg:pt-0">
      ...
      <button className="animate-bounce rounded-full border border-black bg-transparent px-8 py-2.5 text-sm font-medium transition-colors [animation-duration:1.8s] [animation-timing-function:ease-in-out] hover:bg-black hover:text-white">
        Book Now
      </button>
    </div>
  );
